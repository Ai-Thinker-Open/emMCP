...
/* Definitions for emMCP_TickHandleTimers */
osTimerId_t emMCP_TickHandleTimersHandle;
const osTimerAttr_t emMCP_TickHandleTimers_attributes = {
  .name = "emMCP_TickHandleTimers"
};
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the timer(s) */
  /* creation of emMCP_TickHandleTimers */
  emMCP_TickHandleTimersHandle = osTimerNew(emMCP_TickHandleTimersCallback, osTimerPeriodic, NULL, &emMCP_TickHandleTimers_attributes);
...
/* emMCP_TickHandleTimersCallback function */
void emMCP_TickHandleTimersCallback(void *argument)
{
