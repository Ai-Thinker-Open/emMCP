...
#define OLED_CS2_Pin GPIO_PIN_0
#define OLED_CS2_GPIO_Port GPIOB
#define Rd_03L_V2_Pin GPIO_PIN_8
#define Rd_03L_V2_GPIO_Port GPIOA
#define Relay_Pin_Pin GPIO_PIN_5
#define Relay_Pin_GPIO_Port GPIOB
#define IR_STUDE_Pin GPIO_PIN_8
#define IR_STUDE_GPIO_Port GPIOB
