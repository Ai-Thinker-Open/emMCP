...
#elif defined WS281X_PWM_MODE
#include "pwm_ws2812.h"
#define _WS281X_FUNC_DEFINE(_func, ...) ws281x_pwm_##_func(__VA_ARGS__)
#elif defined WS281X_DIGITAL_MODE
#include "digital_ws2812.h"
#define _WS281X_FUNC_DEFINE(_func, ...) ws281x_digital_##_func(__VA_ARGS__)
#else
...
void ws2812_init(ws2812_strip_t *ws2812_strip)
{
	...
	{
		log_error("ws2812_strip is NULL or led_count is 0");
		return;
	}
