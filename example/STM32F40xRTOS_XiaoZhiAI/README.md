...
![Title.png](doc/IMG/96f7298ca0084092b219b695900c7b9b.png)
 ...
 <div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
    <div style="display:flex;align-items:center;margin-bottom:15px">
      <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
      <h3 style="margin:0;font-size:25px;font-weight:bold">项目简介</h3>
    </div>
    <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">

天空星·小智AI 是由立创·天空星GD32F407开发板为主控，安信可Ai-WV01-32S 为AI模块实现的小智AI应用开发板。你可以让它播放音乐、讲故事将笑话，还可以让小智AI为你设置灯条的颜色。<br />
天空星·小智AI 为Ai-WV01-32S提供一个简单的小智AI MCP 控制单片机的示例，通过MCP编程，实现AI控制外设，例如：
- **AI 控制 LED**
- **AI 控制 电机**
- **AI 设置音量**
    </p>
...
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
    <div style="display:flex;align-items:center;margin-bottom:15px">
      <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
      <h3 style="margin:0;font-size:25px;font-weight:bold">主要功能</h3>
    </div>
    <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">
...
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
  <div style="display:flex;align-items:center;margin-bottom:15px">
    <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
    <h3 style="margin:0;font-size:25px;font-weight:bold">功能展示</h3>
  </div>
 <div style="border:2px solid #8224fc;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
    <div style="display:flex;align-items:center;margin-bottom:15px">
        <div style="width:6px;height:20px;background:linear-gradient(to bottom, #7b16ff, #b86bf7);border-radius:4px;margin-right:8px"></div>
        <h4 style="margin:0;font-size:20px;font-weight:bold">颜色控制</h4>
    </div>
  ...
  <div style="border:2px solid #8224fcff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
    <div style="display:flex;align-items:center;margin-bottom:15px">
      <div style="width:6px;height:20px;background-color:#3613faff;background-image:linear-gradient(to bottom, #7b16ffff, #b86bf7ff);border-radius:4px;margin-right:8px"></div>
...
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
  <div style="display:flex;align-items:center;margin-bottom:15px">
    <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
    <h3 style="margin:0;font-size:25px;font-weight:bold">硬件电路</h3>
  </div>
  <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">
...
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
  <div style="display:flex;align-items:center;margin-bottom:15px">
    <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
    <h3 style="margin:0;font-size:25px;font-weight:bold">喇叭及其附件</h3>
  </div>
  
  <!-- 喇叭部分 -->
  <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 20px; margin-top: 20px; padding-bottom: 20px; border-bottom: 1px dashed #e0e0e0;">
    <div style="flex: 1; min-width: 300px;">
      <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">喇叭使用的是某宝找的2W8欧的手机扬声器，我们给它绘制了封装，已经经过验证.</p>
      <p style="margin:0;line-height:1.6;font-size:16px">点击右边图片跳转购买！</p>
    </div>
  ...
  <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 20px; margin-top: 20px; padding-bottom: 20px; border-bottom: 1px dashed #e0e0e0;">
    <div style="flex: 1; min-width: 300px;">
      <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">触点弹片建议使用2.5~3mm高度的弹片，不然出现接触不到</p>
      <p style="margin:0;line-height:1.6;font-size:16px">点击右边图片跳转购买！</p>
    </div>
    <div style="flex: 0 0 auto; max-width: 300px;">
  ...
  <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 20px; margin-top: 20px;">
    <div style="flex: 1; min-width: 300px;">
      <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">固定柱使用的是M1的PCB螺母，这个要用热风枪吹，不然会很难焊（注意：不要加太多的锡，不然会堵孔）</p>
      <p style="margin:0;line-height:1.6;font-size:16px">点击右边图片跳转购买！</p>
    </div>
    <div style="flex: 0 0 auto; max-width: 300px;">
...
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
  <div style="display:flex;align-items:center;margin-bottom:15px">
    <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
    <h3 style="margin:0;font-size:25px;font-weight:bold">软件相关</h3>
  </div>
  <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">
      
  本项目用到的Ai-WV01-32S不采用默认附件，而是安信可开源团队开发的 UART-MCP 固件（固件地址看文本以下内容），**焊好的第一步就是烧录 UART-MCP 固件**，否则无法控制。<br />
   安信可为UART-MCP开发了一套专门的适配库：**emMCP**。只需要非常见到的移植，就能使用。因此 **天空星**只需要关注OLED显示和外设驱动的控制即可。
  </p>
</div>
<br />
<div style="border:3px solid #00a8ff;border-radius:15px;padding:15px;margin:10px 0;box-shadow:0 4px 8px -1px rgba(73, 153, 219, 0.3)">
  <div style="display:flex;align-items:center;margin-bottom:15px">
    <div style="width:6px;height:30px;background-color:#1677ff;background-image:linear-gradient(to bottom, #1677ff, #6bb3f7ff);border-radius:4px;margin-right:8px"></div>
    <h3 style="margin:0;font-size:25px;font-weight:bold">其他资料</h3>
  </div>
  <p style="margin:0 0 15px 0;line-height:1.6;font-size:16px">
      
  - 源码地址：https://gitee.com/Ai-Thinker-Open/emMCP
  - UART-MCP固件下载地址：[点击下载](https://aithinker-static.oss-cn-shenzhen.aliyuncs.com/docs/media/AiPi/AiPi-PalChatV1/Software/AiPi-PalChatV1_UART-MCP_v2.8.zip)
  - MCP参考资料：https://docs.ai-thinker.com/uart_mcp/emMCP.html
  - emMCP 编程资料：https://docs.ai-thinker.com/uart_mcp/emMCP_getStart.html
  - 天空星固件：参考附件
  - 复刻及技术交流：https://bbs.ai-thinker.com/portal.php
  </p>
</div>
<br />
